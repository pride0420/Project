...
CREATE TABLE `shopcar` (
  ...
  CONSTRAINT `por` FOREIGN KEY (`porderId`) REFERENCES `porder` (`porderId`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `shopcar` VALUES (34,77,1,1,3000),(59,91,1,1,3000),(60,77,15,1,4000),(62,85,11,2,4000);
